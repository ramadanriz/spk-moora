                ...
                <table class="w-full text-sm text-center">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 capitalize">
                          ...
                          <td class="px-6 py-4">{{ round($normalize['c1'], 4) }}</td>
                          <td class="px-6 py-4">{{ round($normalize['c2'], 4) }}</td>
                          <td class="px-6 py-4">{{ round($normalize['c3'], 4) }}</td>
                          <td class="px-6 py-4">{{ round($normalize['c4'], 4) }}</td>
                        </tr>
                        @endforeach              
                    </tbody>
                </table>
